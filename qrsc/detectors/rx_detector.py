...
class RXDetector(NNDetector):
    ...
    def __init__(
            ...
            depth=1, width=32, input_dropout=0.0, conv_dropout=0.0,
            epochs=1, gpus=0
    ):
    ...
    def __str__(self):
        return "\n".join([
            ...
            "\tInput Dropout: {}".format(self.input_dropout),
            "\tConvolutional Dropout: {}".format(self.conv_dropout),
    ...
    def _build_model(self):
        ...
        dropout11 = Dropout(self.input_dropout)(visible1)
        dropout12 = Dropout(self.input_dropout)(visible2)
        prev1 = dropout11
        prev2 = dropout12
        for _ in range(self.depth):
            ...
            dropout21 = Dropout(self.conv_dropout)(mp1)
            dropout22 = Dropout(self.conv_dropout)(mp2)
            prev1 = dropout21
            prev2 = dropout22
        fl1 = Flatten()(prev1)
        fl2 = Flatten()(prev2)
