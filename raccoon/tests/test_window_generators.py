...
class TestSignalWindowGenerator(unittest.TestCase):
    ...
    def test_window(self):
        ...
        with self.assertRaises(IndexError): self.swg.window(2, 8)
        with self.assertRaises(IndexError): self.swg.window(0, 7)
        with self.assertRaises(IndexError): self.swg.window(3, 0)
        with self.assertRaises(IndexError): self.swg.window(1, -1)
